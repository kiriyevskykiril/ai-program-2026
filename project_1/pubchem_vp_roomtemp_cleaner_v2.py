...
# -*- coding: utf-8 -*-
"""
pubchem_vp_roomtemp_cleaner_v2.py
...
Run:
    python pubchem_vp_roomtemp_cleaner_v2.py input.csv output_vp_roomtemp.csv

Test one CID:
    python pubchem_vp_roomtemp_cleaner_v2.py --test-cid 244
"""
